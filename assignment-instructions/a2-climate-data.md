...
<br>
To follow along with this demo, please make a copy of the demo station data by clicking this link: [https://bit.ly/CC2023-CDADemo](https://bit.ly/CC2023-CDADemo). Note that the demo uses a different link, but both point to the same file. 
...
### 9.1 Additional tips
The *Useful Information* tab of the [demo data sheet](https://bit.ly/CC2023-CDADemo) contains a few useful spreadsheet equations for this assignment. I've pasted them below for reference: 
